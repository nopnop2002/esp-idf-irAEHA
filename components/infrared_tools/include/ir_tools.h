...
struct ir_builder_s {
    ...
    */
    esp_err_t (*build_frame)(ir_builder_t *builder, int8_t ndata, uint8_t *data);
...
struct ir_parser_s {
    ...
    *
    * @param[in] parser: Handle of IR parser
    * @param[in] length: Number of bits
    * @param[out] ndata: Number of data
    * @param[out] data: Data of the scan code
    ...
    */
    esp_err_t (*get_scan_code)(ir_parser_t *parser, uint32_t length, int8_t *ndata, uint8_t *data, bool *repeat);
...
/**
* @brief Creat a AEHA protocol builder
*
* @param config: configuration of AEHA builder
* @return
*      Handle of AEHA builder or NULL
*/
...
/**
* @brief Creat a AEHA protocol parser
*
* @param config: configuration of AEHA parser
* @return
*      Handle of AEHA parser or NULL
*/
